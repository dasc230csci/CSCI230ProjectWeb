<%@page language="java" import="UI.*, Entity.*, Controller.*"%>
...
if(success != null && success.equals("1")){
	out.println("School was successfully edited added");
...
<body>
<%
	UniversityController UniCon = new UniversityController();
    out.println("Edit/View University : " + request.getParameter("schoolName"));
    University theUni = UniCon.getUniversityInDetailed(request.getParameter("schoolName"));
    %>
<form method="post" action="EditUni_action.jsp" name="view_editUniversity">
...
<td style="vertical-align: top; width: 218px;"><input value="<%out.print(theUni.getEmphases().get(0)); %>"
name="emphases1"><input value="<%if(theUni.getEmphases().size()>=2){out.print(theUni.getEmphases().get(1));}%>" name="emphases2"><input value="<%if(theUni.getEmphases().size()>=3){out.print(theUni.getEmphases().get(2));}%>"
name="emphases3"><input value="<%if(theUni.getEmphases().size()>=4){out.print(theUni.getEmphases().get(3));}%>" name="emphases4"><br>
</td>
</tr>
<tr>
